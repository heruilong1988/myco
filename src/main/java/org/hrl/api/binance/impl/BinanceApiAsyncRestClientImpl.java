...
import static org.hrl.api.binance.impl.BinanceApiServiceGenerator.createService;

import org.hrl.api.binance.BinanceApiAsyncRestClient;
...
import org.hrl.api.binance.domain.account.request.AllOrdersRequest;
...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
  ...
  public void withdraw(String asset, String address, String amount, String name, String addressTag, BinanceApiCallback<WithdrawResult> callback) {
    binanceApiService.withdraw(asset, address, amount, name, addressTag, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System
        .currentTimeMillis())
        .enqueue(new BinanceApiCallbackAdapter<>(callback));
  }
