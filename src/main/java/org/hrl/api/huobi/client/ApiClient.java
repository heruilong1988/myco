...
import org.hrl.api.huobi.request.DepthRequest;
import org.hrl.api.huobi.request.IntrustOrdersDetailRequest;
...
class ApiSignature {
     ...
     * @param uri          请求路径，注意不含?以及后的参数，例如"/v1/org.hrl.api/info"
